...
sec.grpdiff.names<-names(cbind(ugsatis22.quan[1:3],ugsatis22.quan[78:ncol(ugsatis22.quan)]))#the first cols and the ending mutated cols
...
multivariate regression: where (e.g. sections of food stais, etc.) are
the differences (e.g. by years, demographics, etc.

the three overall questions at the beginning : compare historical however
far back we have
