...
y<-corepath%>%mutate(matric=case_when(GRADUATED_YN=="Y"~"Graduated",
                                         GRADUATED_YN!="Y"~"Not Graduate"))%>%
...
```{r prt term for coursegroup}
#for each coursegroup, prt of each term - OVERALL
...
#by graduated vs not graduated students
