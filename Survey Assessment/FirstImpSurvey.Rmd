...
```{r respondent_figures,include=TRUE,fig.height=2}
gridExtra::grid.arrange(resp_rate,ResAll.rcstatus, ResAll.gd, nrow=1)
ResAll.eth
...
```{r overview and compare last year}

#satis.course2&ac2

#satis.food1&resid2#satis.activity1
```

```{r table by gender and race}
