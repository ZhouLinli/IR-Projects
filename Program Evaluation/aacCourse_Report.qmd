---
title: "Academic Achievement Center (AAC) Courses Review"
format: pdf
---
...
#col_cf<-function(i=1,kbl=static_tab.sec,df=tab.sec){column_spec(
 # kable_input=kbl,column=i,color = "white",background =cf_color(df[i]))}
```

# Summary

* Among the past 5 years (2018 Fall to 2022 Spring), AAC 103 course has an average enrollment of 50 students.
* Average pass rate for AAC 103 course is 82%.
* Students with higher than 2.0 semester GPA usually have higher pass rate in AAC103 than students with lower than 2.0 semester GPA.
* An average of 73% students in AAC 103 course have a higher than 2.0 semester GPA. 
* Among those who pass AAC 103, 77% have a higher than 2.0 GPA and 23% do not have a good enough semester GPA. Among those who failed AAC 103, 58% still have a higher than 2.0 semester GPA (without succeeding in AAC 1O3 course).
* Taking AAC 103 the second and third times does not improve pass rate or percentage of obtaining higher than 2.0 semester GPA.
...
kbl(align = "c",label="tab.aacenroll",#in-text reference
...
static_tab.aacenroll<-column_spec(
  ...
  column=i,background =cf_color(tab.aacenroll[i],a=70,b=50))
i=i+1
...
Among the past 5 years (2018 Fall to 2022 Spring), AAC courses enrollment range from 34 to 79. An average enrollment for AAC103 is 50 students.
...
kbl(align = "c",label="tab.aacpass",#in-text reference
...
Average pass rate for AAC courses are above 82% across the past 5 academic years.
...
kbl(align = "c",label="tab.semgpa_pass",#in-text reference
...
column_spec(4, width = "5em", background = if_else(tab.semgpa_pass[4]>.3,color_grey,if_else(tab.semgpa_pass[4]>.18,color_greylight,"white")))

#apply cf_color to multi columns
for (i in 2:3){
static_tab.semgpa_pass<-column_spec(
  kable_input=static_tab.semgpa_pass,
  column=i,color = "black",width = "5em",
...
Students with higher than 2.0 semester GPA usually have higher pass rate in AAC103 than students with lower than 2.0 semester GPA. The difference of AAC103 pass rate for students from different semester GPA is as large as 34% in 2020 Fall.
...
kbl(align = "c",label="tab.semGPA",#in-text reference
    caption = "Percentage of higher than 2.0 semester GPA", #table title
...
static_tab.semGPA<-column_spec(
  ...
  column=i,color = "black",width = "5em",
  background =cf_color(tab.semGPA[i],a=.8,b=.7))
i=i+1
static_tab.semGPA}
```
...
An average of 85% students in AAC 102 course have a higher than 2.0 semester GPA in the past 5 years. The average percentage of higher than 2.0 semester GPA for AAC 103 course is 73%. 
...
kbl(align = "c",label="tab.semGPA_passfail",#in-text reference
    caption = "Percentage of higher than 2.0 semester GPA among students who passed or failed AAC103", #table title
...
row_spec(0,align = "c",color="black")%>%
#set first column: 
  column_spec(1, border_right = F, background = "white", width = "10em",color="black")

for (i in 2:ncol(tab.semGPA_passfail)){
static_tab.semGPA_passfail<-column_spec(
  kable_input=static_tab.semGPA_passfail,
  column=i,color = "black",width = "5em",
  background =cf_color(tab.semGPA_passfail[i],a=.8,b=.7))
i=i+1
...
Among students who passed AAC 103, an average of 77% students have a higher than 2.0 semester GPA. In contrast, only an average of 58% students have a higher than 2.0 semester GPA among students who failed AAC 103.
...
In analysis, we found 4 students took AAC 103 4 times and 2 of them took the course 5 times. Due to the small sample size, we exclude those students from pass rate reviewing. The following tables reported students who took AAC 103 for the 1st, 2nd, and 3rd time. 
...
kbl(align = "c",label="tab.retakepass",#in-text reference
    caption = "AAC103 pass rates for different times of retaking the course", #table title
...
row_spec(0,align = "c",color="black")%>%
#set first column: 
  column_spec(1, border_right = F, background = "white", color="black")%>%
...
First time takers has the highest pass rate of 83%. In other words, AAC 103's pass rate did not increase for along with students times of retaking the course. 
...
kbl(align = "c",label="tab.retake_semGPA",#in-text reference
    caption = "Higher than 2.0 Semester GPA for different times of retaking the course", #table title
...
#set first column: 
  column_spec(1, border_right = F, background = "white", color="black")%>%
  column_spec(2,background = cf_color(tab.retake_semGPA[2],a=.8,b=.7))%>%
  column_spec(3,width = "4em")
```
...
Percentage of higher than 2.0 semester GPA among AAC 103 retakers range from 46%-73%. The second time that students taking AAC 103 has 73%, the highest percentage, of higher than 2.0 GPA. 
