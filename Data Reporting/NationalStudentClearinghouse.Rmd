...
#save student info/detail rows
write.csv(nsc,"/Users/linlizhou/Documents/LASELL/data/completion/NSCug13-22.csv")
```
...
nsc[nrow(nsc) + 1,] = c("T1",#indicate trailer row
                        nrow(nsc)+1,#row count + header row
