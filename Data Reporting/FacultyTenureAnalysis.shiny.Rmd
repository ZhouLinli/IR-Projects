...
change.avgrank%>%formattable(list(
  ...
  Change=formatter("span", style = ~ style(color = ifelse(Change >0, "darkgreen", "black")),
                    ~ icontext(ifelse(Change >0,"thumbs-up", "arrow-down"), Change)),
  Rank= formatter("span",font.weight="bold",
