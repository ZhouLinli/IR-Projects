...
axis.text = element_text(family = font, size = 16),

axis.text.x = element_text(family = font, size = 16, margin = margin(t=5,b=10)),
...
strip.text = element_text(family = font, size = 16, margin = margin(t=5,b=10)),#move up is + 1
