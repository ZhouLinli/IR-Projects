...
satis.aca.figure<-prtdf%>%filter(item%in%c("satis.overallcourse","satis.majorcourse", "satis.acchallenge", "satis.accommit"),year>2019)%>%
 ...
 # theme_lz()+#theme(axis.text.x = element_text(), legend.position = "none")+
  ...
  facet_wrap(~factor(item,levels =c("satis.overallcourse","satis.majorcourse", "satis.acchallenge", "satis.accommit"),labels = c("Overall Courses","Major Courses","Academic Challenge","Academic Commitment")),nrow=1) +
  geom_line(aes(y = prt, x=year, group=item, 
                ...
                linetype=factor(item,levels =c("satis.overallcourse","satis.majorcourse", "satis.acchallenge", "satis.accommit"))),stat="identity")+
  scale_color_manual(name="",values=c("black","#6C6F70","#6C6F70","#6C6F70"))+
  scale_linetype_manual(name="",values=c("solid","longdash","longdash","longdash"))
