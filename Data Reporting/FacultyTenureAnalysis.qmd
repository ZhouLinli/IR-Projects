...
labs(title=str_wrap("Proportion of Faulcty in Different Tenured Status from 2016-2021",50),x="",y="")+
...
labs(title="Tenured Faculty by Rank from 2016-2021",x="",y="")
```
...
scale_color_discrete(name="")+
theme_lz_ppt()+theme(axis.text.y=element_blank())+
labs(title="Tenured Faculty by Legal Sex from 2016-2021",x="",y="")
```
