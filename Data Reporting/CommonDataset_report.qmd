...
# CDS-B2 Degseek Fall Enrollment: race (degseek vs ftfy)

```{r factorize}
#for convnience of reporting
degsk<-degsk%>%mutate(Ethnicity=factor(Ethnicity,
...
```{r report_alldegsk.race}
#report all degsk race
degsk%>%count(Ethnicity)
```
