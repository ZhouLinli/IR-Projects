...
ipeds<-ug.gd%>%select(-CreditPrt,-`Cum Credits`,-Program,-`gov id`,-`Birth Date`,-age,-age.cat)%>%unique()
str(ipeds)#check
...
ipeds[ipeds$`People Code Id` %in% dup.id$`People Code Id`,]%>%
  arrange(Level,`People Code Id`)#######it's b/c FT/PT, new/return, term credits, term
