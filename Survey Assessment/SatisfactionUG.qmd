...
```{r tbl_samvspop}
tbl_samvspop<-left_join(gpvar.tbl_sample,gpvar.tbl_population)%>%filter(!is.na(Population),Population>.015)

tbl_samvspop$type<-recode(tbl_samvspop$type,Y="Transfer",N="Not-transfer",
