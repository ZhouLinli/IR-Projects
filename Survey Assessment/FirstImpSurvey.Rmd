...
satis.aca.figure<-prtdf%>%filter(item%in%c("satis.overallcourse","satis.majorcourse", "satis.acchallenge", "satis.accommit"),year>2019)%>%
  ...
  labs(title=str_wrap("",40),x="",y="",fill="") +
  theme_lz()+theme(legend.position = "top")+
...
```{r satis figure, include=TRUE}
satis.aca.figure
```

## Life Satisfaction

```{r satis.life figure, include=TRUE}
satis.life.figure
```
...
```{r service figure, include=TRUE}
service.use.figure
```


## Services Satisfaction
```{r service.satis figure, include=TRUE, fig.height=1.7}
