...
-   Among the past 5 years (2018 Fall to 2022 Spring), AAC 103 course
    has an average enrollment of 50 students.
...
`r tab.retakepass[1,"Pass rate"]`, while the pass rate decreased to
`r tab.retakepass[2,"Pass rate"]` and `r tab.retakepass[3,"Pass rate"]`
