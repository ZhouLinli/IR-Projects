...
ggplot(aes(x = prt, fill=RespondentOverall, y=RCstatus)) +
  ...
  geom_text(aes(label=paste0(prt)),size=3,position = position_dodge(0.9))+#, " ", RCstatus," among ",RespondentOverall
  scale_fill_manual(values = c("#6C6F70","#69b3e7"))+#fill legend labels=c(""),name="")
  coord_flip()
```
...
ggplot(aes(x = prt, fill=RespondentOverall, y=gender)) +
  ...
  geom_text(aes(label=paste0(prt)),size=3,position = position_dodge(0.9))+#, " ", gender," among ",RespondentOverall
  scale_fill_manual(values = c("#6C6F70","#69b3e7"))+#fill legend labels=c(""),name="")
  coord_flip()
```
...
theme_lz()+
  ...
  geom_text(aes(label=paste0(prt)),size=3,position = position_dodge(0.9))+#, " ", Ethnicity," among ",RespondentOverall
  scale_fill_manual(values = c("#6C6F70","#69b3e7"))+#fill legend labels=c(""),name="")
  coord_flip()
```
...
gridExtra::grid.arrange(ResAll.waffle,ResAll.rcstatus, ResAll.gd, nrow=1)
ResAll.eth
