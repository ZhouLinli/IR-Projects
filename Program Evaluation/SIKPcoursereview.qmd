...
tab.mjcnt<-stucrs.si%>%group_by(coursegrp,Major)%>%
  ...
  mutate(across(BIO:SCI, function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.biocnt<-tab.biocnt%>%
  mutate(across(names(tab.biocnt)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.chemcnt<-tab.chemcnt%>%
  mutate(across(names(tab.chemcnt)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.envcnt<-tab.envcnt%>%
  mutate(across(names(tab.envcnt)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.physcnt<-tab.physcnt%>%
  mutate(across(names(tab.physcnt)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.scicnt10<-tab.scicnt10%>%
  mutate(across(names(tab.scicnt10)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.scicnt11<-tab.scicnt11%>%
  mutate(across(names(tab.scicnt11)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
...
tab.cjcnt<-stucrs.si%>%filter(grepl("^CJ",coursecode))%>%
  ...
  pivot_wider(names_from=coursecode,values_from=prt,values_fill=0)
tab.cjcnt<-tab.cjcnt%>%
  mutate(across(names(tab.cjcnt)[-1], function(x) percent(x, digit=0)))%>%arrange(Major)  #make numbers percentage
