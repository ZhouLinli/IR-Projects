...
theme(axis.text.y=element_text(size=12))+theme(panel.grid.major.y = element_line(color = "grey95"), panel.grid.minor.y = element_line(color = "grey95"))+#theme(legend.position = "right", legend.direction = "vertical")+
...
scale_color_discrete(name="")+
theme(axis.text.y=element_text(size=12))+theme(panel.grid.major.y = element_line(color = "grey95"))+
...
ggplot(data=plot_dat, aes(x=Year,y=prt,color=Department,group=Department))+geom_line()+
  #scale_color_discrete(limits = dep.order[dep.order %in% input$mylist])+
    scale_y_continuous(labels=scales::percent_format(accuracy = 1))+
    theme(axis.text.y=element_text(size=18),legend.direction = "vertical")+
    theme(panel.grid.major.y = element_line(color = "grey95"))+
    labs(x="",y="",title=str_wrap("Selected Departments' Historical Trends of Tenure-Line Faculty Proportion",40))
  })}
