...
ui <- fluidPage(#start fluidPage
    ...
    sidebarLayout(#layout
      ...
      sidebarPanel(sliderInput(
        "bins", # Slider: waiting for input of number of bins to define bins
        "Number of bins:",#Slider title
        min = 1, max = 50,value = 30)),#Slider appearance
      
      mainPanel(plotOutput("distPlot")))# mainpanel:a plot output named as defined in server
    )#end of fluidPage
```
...
ggplot(
  ...
  filter(dat,TargetVariable==input$my_cong),
