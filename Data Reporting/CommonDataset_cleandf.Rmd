...
#NOT SURE IF HAVE completion program: enroll16fall%>%str_detect(Curriculum, "[Cc]ompletion")
#full time: enroll16fall%>%count(`FT/PT`)
```

```{r}
#select ssn list of "first time, full time, dgsk" UG students
dgsk.FT.ft_ssn<-enroll16fall%>%filter(
