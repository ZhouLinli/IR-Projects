...
racepvt%>%ggplot(aes(x=factor(Year),y=prt,color=factor(`Race/Ethnicity`),linetype=factor(`Race/Ethnicity`),group=factor(`Race/Ethnicity`)))+geom_line()+
  scale_color_manual(name="",limits=nrace$race, values = c("black","blue","chartreuse3","darkgoldenrod","brown1","deeppink4"),labels=c("White","Asian","International","Hispanic","Black","Muti-races"))+  
  scale_linetype_manual(name="",limits=nrace$race, values = c("solid","longdash","twodash","solid","longdash","twodash"),labels=c("White","Asian","International","Hispanic","Black","Muti-races"))+
