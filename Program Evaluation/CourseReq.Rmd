...
major.list[(major.list%in%major.col)==FALSE]
"Radio and Video Production" %in% major.col
#select
dat.48major<-dat.major%>%select(major.list[1:20],`Radio and Video Production`)
```
