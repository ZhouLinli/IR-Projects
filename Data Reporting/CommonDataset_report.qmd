...
```{r report_firsttime and others}
#did not ask to report dgsk first year
...
#no other dgsk (dgsk are all reported as dgsk first time, since non no-first-timer)
...
```{r report_firstyear and others}
#assuming they mean to ask dgsk first year
...
#other dgsk: dgsk and non first year
gdenroll%>%filter(Degree!="NON",#dgsk students 
