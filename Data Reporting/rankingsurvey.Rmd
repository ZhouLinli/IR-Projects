...
```{r enrollment in loan dataset questions}
usn.enroll<-read_excel("/Volumes/lasellshare/Faculty_Staff_Shares$/IR/Fin Aid Sharing/2022 US News/StudentLoanInfo_USNewsReport.xlsx")#indeed we saved it there for jennifer with that file name
#answering questions:
