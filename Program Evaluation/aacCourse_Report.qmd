...
#set overall style
  kable_styling(latex_options = c('hold_position', 'striped'),#for non html output
...
static_tab.aacenroll<-column_spec(
  ...
  column=i, width = "3em",background =cf_color(tab.aacenroll[i],a=70,b=50))
i=i+1
...
#set overall style
  kable_styling(latex_options = c('hold_position', 'striped'),bootstrap_options = c("striped", "hover", "condensed", "responsive"),
              full_width = F, fixed_thead = T, font_size = 12)%>%
#set header row
#row_spec(0,align = "c",color="black")%>%
#set first column: 
...
column_spec(4, width = "4em", background = if_else(tab.semgpa_pass[4]>.3,color_grey,if_else(tab.semgpa_pass[4]>.18,color_greylight,"white")))
...
#set header row row_spec(0,align = "c",color="black")%>%
#set first column: 
  column_spec(1, border_right = F, background = "white", width = "2em",color="black")
...
#set first column: 
  column_spec(1, border_right = F, background = "white", color="black")%>%
  column_spec(2,width = "4em",background = cf_color(tab.retake_semGPA[2],a=.8,b=.7))%>%
  column_spec(3,width = "3em")
```
