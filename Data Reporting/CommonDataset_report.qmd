...
complete<-complete%>%mutate(degree_awarded=factor(degree_awarded,
              levels = c("bachelor","associate","certificates")))
```

```{r report_cip.prt}
complete%>%filter(degree_awarded!="master")%>%#do not report master
