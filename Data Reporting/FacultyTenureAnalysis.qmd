...
1. Tenure status by year
  + How has the proportion of tenure-line and non-tenure-line faculty changed over time?

2. Tenure status by demography (rank, race, sex)
  + How has the proportion of tenure-line faculty in certain rank, racial, or sex groups changed over time?

3. Tenure status for small, medium, and large department
  + How has the proportion of tenure-line and non-tenure-line faculty changed over time for different departments?
...
labs(title="Tenured Faculty of Different Ranks",x="",y="")
```
...
labs(title=str_wrap("Tenured Faculty in Different Racial Groups",80),x="",y="")
```
...
labs(title="Gender Gaps for Tenured Faculty",x="",y="")
```
