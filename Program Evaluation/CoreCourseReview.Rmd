...
CourseCode%in%c("BIO101", "BIO102", "BIO107", "BIO113", "CHEM105", "CHEM203", "ENV206", "ENV211", "ENV220", "PHYS111", "PHYS112", "SCI103", "SCI104", "SCI105", "SCI106", "SCI114", "SCI115", "BIO117", "BIO207", "CHEM118", "PHYS107", "PHYS108")  ~ "Scientific Inquiry & Problem Solving",
...
sectiontally<-sectiontally%>%filter(sectiontally$coursecode %in% corelist$CourseCode)#check: %>%count(coursecode)#1338 rows
