...
###For 5Bachelors, NONE (except Bachelors Completion and business administration) can be completed entirely via distance education.  
###For 7Master's and 6CER, ALL (expect in Education) can be completed entirely via distance education.
```
