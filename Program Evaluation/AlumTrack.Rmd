...
gd6m_s<-gd6m%>%select(
  PC_ID, 
  Employment, #EMPLOYED VAR -- changed to original var containing schooling info
...
names(gd6m_s)<-c("PCID","Employment","Employer","Title","Income","Continue Education","Institution","Degree", names(gd6m)[73:82])
...
#rename for consistency across all df
names(survey_s)<-c("PCID","Employment","Employer","Title","Income","Continue Education","Institution","Degree", names(gd6m)[73:82])
...
#rename for consistency across all df
names(linkedin_s)<-c("PCID","Employment","Employer","Title","Continue Education","Institution","Degree")
```
