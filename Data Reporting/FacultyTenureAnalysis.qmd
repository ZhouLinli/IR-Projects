...
theme_lz_ppt()+theme(axis.text.y=element_blank())+
labs(title=str_wrap("Tenure-line Faculty in Large Racial Groups (n>80)",40),x="",y="")
...
scale_y_continuous(breaks = seq(.3,.5,by=.1),labels = scales::percent)+
theme_lz_ppt()+theme(axis.text.y=element_blank())+
labs(title=str_wrap("Tenure-line Faculty in Small Racial Groups (n<80)",40),x="",y="")
...
scale_color_discrete(name="")+
theme_lz_ppt()+theme(axis.text.y=element_blank())+
labs(title="Tenure-line Faculty by Legal Sex",x="",y="")
```
...
#Male faculties have 8% more tenured rate than female faculty.
```

```{r tenure-by-race, include=FALSE}
#set order
