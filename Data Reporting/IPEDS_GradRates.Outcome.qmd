...
#2.pell and stafford (finaid data file for 2014 fall and 2015 spring enrolled students)
...
#degree-seeking, new students in 2014 fall and 2015 spring backup data

#the 2014 fall degsknew students should match/identifical with 2014 (fall) cohort in retention file
ret%>%filter(Cohort==2014)%>%
  select(GENDER_CODE,ETHNICITY_REPORT_DESC,Cohort,SSN,PC_ID,`First Name`,`Last Name`)#to be added: finaid
