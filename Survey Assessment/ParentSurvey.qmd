...
#names(parent.quan)
plot.satisoverall<-parent%>%count(satis.overall)
```
...
```{r plot.info_conv}
#6
#"infoconv_aca"             "infoconv_gradplan"       "infoconv_career"          "infoconv_fin"            
"infoconv_campus"          "infoconv_health" 
```
